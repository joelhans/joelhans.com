...
updatedOn: '2023-05-06T13:56:35.164Z'
...
<Statement>When someone wants a unit of my creativity, it's now in the form of a well-defined transaction. The rest stays with me.</Statement>
...
<Aside>A complete tell-all will have to wait, but here's a [hint](/articles/get-started-athens/).</Aside>
...
Let's pretend I have `10 units` of creativity to offer in a single day. Typically, when I've worked a full-time,
creative job, it takes about 80% of my creative energy, or `8 units`. The problem wasn't that the salary was too low for
those `8 units`.

<Statement>The problem was that I wasn't being compensated fairly for what little creativity I had left for myself.</Statement>
...
[timeboxing](https://en.wikipedia.org/wiki/Timeboxing). I can make micro-adjustments to make sure that there's always a
balance between the creativity I give away and what I keep for myself.

These days, I'm a lot closer to `4 units` to work and `6 units` to myself. It's more sustainable, I'm happier, and my
novel is _finally_ getting the attention it deserves.

If I start moving toward burnout again, I either ratchet down the freelance work, or make darn sure I'm getting
compensated fairly for the little creativity I get to keep.
